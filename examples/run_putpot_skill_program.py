...
def _parser() -> argparse.Namespace:
    ...
    parser.add_argument("--bimanual-contact-hold-steps", type=int, default=90)
...
def _build_skill(
    ...
    program.bimanual_handle_grasp(
        ...
        approach_steps=110,
        left_close_steps=60,
        # Keep both grippers closed at their measured handle frames long
        # enough for either first-latched contact to stabilize the pot while
        # the opposite wrist closes its signed handle-frame residual.
        right_close_steps=args.bimanual_contact_hold_steps,
        simultaneous=True,
    )
...
def main() -> None:
    ...
    if (
        ...
        or min(
            args.bimanual_contact_hold_steps,
