...
def _parser() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=0,
        help=(
            "Initial rows of the same straight open return that retain the "
            "release orientation before completing the original shortest-arc "
            "rotation to demonstrated rest."
        ),
    )
    parser.add_argument(
...
def _build_skill(
    ...
    if direct_contract:
        from judo_isaaclab.hang_mug import delay_post_release_return_rotation

        trajectory = delay_post_release_return_rotation(
            trajectory,
            args.post_release_return_rotation_delay_steps,
        )
    return (
        trajectory,
        final_mug_pose,
...
def main() -> None:
    ...
    rotation_delay_steps = args.post_release_return_rotation_delay_steps
    if (
