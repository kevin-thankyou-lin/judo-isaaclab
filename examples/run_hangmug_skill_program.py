...
def _parser() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--post-release-return-ramp-steps",
        type=int,
        default=0,
        help=(
            "Optional rows, at most eight, for the screened direct retreat to "
            "reach demonstrated rest; remaining return rows hold that target."
        ),
    )
    parser.add_argument(
...
def _build_skill(
    ...
    if direct_contract:
        ...
        program.release_and_return_to_rest(
            ...
            return_ramp_steps=args.post_release_return_ramp_steps or None,
        )
    else:
...
def main() -> None:
    ...
    return_ramp_steps = args.post_release_return_ramp_steps
    if (
            ...
            if semantic_step is not None and any(
                ...
                trajectory = reanchor_branch_transport_contact(
                    ...
                    post_release_return_ramp_steps=(
                        args.post_release_return_ramp_steps or None
                    ),
                )
