...
def _bounded_pick_pad_depth(value: float) -> float:
    depth = float(value)
...
def _build_skill(
    ...
    left_grasp = seat_grasp_inside_finger_pads(
        left_grasp, _bounded_pick_pad_depth(args.pick_pad_depth_m)
    )
