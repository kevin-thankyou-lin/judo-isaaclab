...
def _parser() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=0,
        help=(
            "Optional moving-prefix rows within the direct return; remaining "
            "rows hold the same demonstrated rest endpoint."
        ),
    )
    parser.add_argument(
...
def _build_skill(
    ...
    if direct_contract and args.post_release_return_motion_steps:
        trajectory = profile_direct_return_with_endpoint_hold(
            trajectory,
            motion_steps=args.post_release_return_motion_steps,
        )
    return (
        trajectory,
        final_mug_pose,
